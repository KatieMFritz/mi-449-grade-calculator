// scope everything. But maybe switch to Parcel to compile instead.
;(function() {
  ///////////////////////////////
  /* Shared Variables */
  ///////////////////////////////
  ...
  // Set some dates
  // TODO: switch to date-fns instead of Moment
  ...
  // TODO: change to function initialize () {}
  ...
  var updateProjectMath = function() {
    ...
    totalPoints =
      Math.round(
        (x09Projects.value * 0.09 +
          x19Projects.value * 0.19 +
          x28Projects.value * 0.28) *
          100
      ) / 100
  ...
  var clearData = function() {
    var confirm = window.confirm(
      'Are you sure you want to remove your saved data?'
    )
    if (confirm) {
      localStorage.clear()
      location.reload()
  ...
  x09Projects.addEventListener('input', updateProjectMath)
  x19Projects.addEventListener('input', updateProjectMath)
  x28Projects.addEventListener('input', updateProjectMath)
})()
